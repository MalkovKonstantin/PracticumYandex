package _03_Methods.Practicum10;
...
public class Practicum10 {
    ...
    private static void convert(Scanner scanner, double moneyBeforeSalary) {
        double rateUSD = 78.5;
        double rateEUR = 85;
        double rateJPY = 0.74;
    ...
    private static double saveExpense(Scanner scanner, double moneyBeforeSalary, double[] expenses){
